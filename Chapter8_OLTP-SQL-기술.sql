...
SELECT  *
FROM    TABLE(DBMS_XPLAN.DISPLAY_CURSOR('41pcm6d3br6sf',0,'ALLSTATS LAST'));
...
SELECT  *
FROM    TABLE(DBMS_XPLAN.DISPLAY_CURSOR('2wnsvsd9g4ku5',0,'ALLSTATS LAST'));
...
SELECT  *
FROM    TABLE(DBMS_XPLAN.DISPLAY_CURSOR('g5mtu3pkr920m',0,'ALLSTATS LAST'));
