...
FROM    V$SQL T1
WHERE   T1.SQL_TEXT LIKE '%GATHER_PLAN_STATISTICS LEADING(T1) USE_MERGE(T2)%'
ORDER BY T1.LAST_ACTIVE_TIME DESC;


SELECT  *
FROM    TABLE(DBMS_XPLAN.DISPLAY_CURSOR('18a5gm8p95p4t',0,'ALLSTATS LAST'));
...
SELECT  T1.SQL_ID ,T1.CHILD_NUMBER ,T1.SQL_TEXT
FROM    V$SQL T1
WHERE   T1.SQL_TEXT LIKE '%GATHER_PLAN_STATISTICS LEADING(T1) USE_HASH(T2)%'
ORDER BY T1.LAST_ACTIVE_TIME DESC;


SELECT  *
FROM    TABLE(DBMS_XPLAN.DISPLAY_CURSOR('2vckg3w0twy29',0,'ALLSTATS LAST'));
...
SELECT  *
FROM    TABLE(DBMS_XPLAN.DISPLAY_CURSOR('64rutf4xk2sjd',0,'ALLSTATS LAST'));
...
SELECT  T1.SQL_ID ,T1.CHILD_NUMBER ,T1.SQL_TEXT
FROM    V$SQL T1
WHERE   T1.SQL_TEXT LIKE '%GATHER_PLAN_STATISTICS LEADING(T1) USE_NL(T2) INDEX(T2 X_T_ORD_JOIN_1)%'
ORDER BY T1.LAST_ACTIVE_TIME DESC;


SELECT  *
FROM    TABLE(DBMS_XPLAN.DISPLAY_CURSOR('2r1tcta4ru6j7',0,'ALLSTATS LAST'));
...
SELECT  T1.SQL_ID ,T1.CHILD_NUMBER ,T1.SQL_TEXT
FROM    V$SQL T1
WHERE   T1.SQL_TEXT LIKE '%GATHER_PLAN_STATISTICS LEADING(T1) USE_NL(T2) INDEX(T2 X_T_ORD_JOIN_2)%'
ORDER BY T1.LAST_ACTIVE_TIME DESC;


SELECT  *
FROM    TABLE(DBMS_XPLAN.DISPLAY_CURSOR('aw25899rc9ryw',0,'ALLSTATS LAST'));
...
SELECT  T1.SQL_ID ,T1.CHILD_NUMBER ,T1.SQL_TEXT
FROM    V$SQL T1
WHERE   T1.SQL_TEXT LIKE '%GATHER_PLAN_STATISTICS LEADING(T2) USE_NL(T1) INDEX(T2 X_T_ORD_JOIN_2)%'
ORDER BY T1.LAST_ACTIVE_TIME DESC;


SELECT  *
FROM    TABLE(DBMS_XPLAN.DISPLAY_CURSOR('4jh305fymk6gj',0,'ALLSTATS LAST'));
...
SELECT  *
FROM    TABLE(DBMS_XPLAN.DISPLAY_CURSOR('55u3gdh55w3sg',0,'ALLSTATS LAST'));
...
SELECT  *
FROM    TABLE(DBMS_XPLAN.DISPLAY_CURSOR('d0mkxka3juy5t',0,'ALLSTATS LAST'));
...
SELECT  T1.SQL_ID ,T1.CHILD_NUMBER ,T1.SQL_TEXT
FROM    V$SQL T1
WHERE   T1.SQL_TEXT LIKE '%GATHER_PLAN_STATISTICS LEADING(T2) USE_NL(T1) FULL(T2)%'
ORDER BY T1.LAST_ACTIVE_TIME DESC;


SELECT  *
FROM    TABLE(DBMS_XPLAN.DISPLAY_CURSOR('a319wbtvb7mzx',0,'ALLSTATS LAST'));
...
SELECT  T1.SQL_ID ,T1.CHILD_NUMBER ,T1.SQL_TEXT
FROM    V$SQL T1
WHERE   T1.SQL_TEXT LIKE '%GATHER_PLAN_STATISTICS LEADING(T1) USE_MERGE(T2) FULL(T2)%'
ORDER BY T1.LAST_ACTIVE_TIME DESC;


SELECT  *
FROM    TABLE(DBMS_XPLAN.DISPLAY_CURSOR('4h89vg74pgwh3',0,'ALLSTATS LAST'));
...
SELECT  *
FROM    TABLE(DBMS_XPLAN.DISPLAY_CURSOR('7tdby1j1tk4r0',0,'ALLSTATS LAST'));
